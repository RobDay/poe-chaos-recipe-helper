    ...
    useEffect(() => {
      ...
      if (itemCounts) {
        return (
            ...
            <SizedItemCountCell itemName="🎩" itemCount={itemCounts.HELMET} color="red"/>
            <SizedItemCountCell itemName="🥋" itemCount={itemCounts.BELT} color="orange" />
            <SizedItemCountCell itemName="🧥" itemCount={itemCounts.ARMOR} color="yellow" />
            <SizedItemCountCell itemName="🥊" itemCount={itemCounts.GLOVES} color="green" />
            <SizedItemCountCell itemName="🥾" itemCount={itemCounts.HELMET} color="blue" />
            <SizedItemCountCell itemName="⚔️" itemCount={itemCounts.ONE_HANDED_WEAPON} color="indigo" />
            <SizedItemCountCell itemName="🏹" itemCount={itemCounts.TWO_HANDED_WEAPON} color="violet" />
            <SizedItemCountCell itemName="💍" itemCount={itemCounts.RING} color="cyan" />
            <SizedItemCountCell itemName="📿" itemCount={itemCounts.AMULET} color="gray" />
        </FlexContainer>
        );
      }
